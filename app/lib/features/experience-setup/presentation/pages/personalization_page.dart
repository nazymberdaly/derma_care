...
import 'package:derma_care/features/experience-setup/presentation/widgets/question_card.dart';
          ...
          children: [
            ...
            CustomButton(
              onPressed: canContinue
                  ? () => context.go(
                        '/experience-setup/completion?skinConcern=$selectedSkinConcern&skinType=$selectedSkinType',
                      )
                  : null,
              text: 'Save & Continue',
            ),
